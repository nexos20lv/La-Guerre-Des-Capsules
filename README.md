...
## ðŸ’œ Le Jeu
Incarnez une capsule et affrontez vos ennemis dans des arÃ¨nes dynamiques. Le jeu est entiÃ¨rement codÃ© en GDScript en utilisant le moteur open-source Godot.

## ðŸ› ï¸ Compilation
1. Ouvrez le projet dans Godot Engine (version 4.x recommandÃ©e).
2. Lancez la scÃ¨ne principale pour jouer.
